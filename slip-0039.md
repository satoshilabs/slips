...
1. <a name="FiniteField"/>**Choice of finite field**
...
2. <a name="IndexEncoding"/>**Index encoding**
...
4. <a name="KDFParam"/>**Choice of KDF function and parameters**
...
7. <a name="PassphraseVerification"/>**Passphrase verification**
