...
4.  Let *a* be a two-dimensional array of bytes with dimensions *T* by len(*PMS*) such that *a*[0] = *PMS*, *a*[*T*-1][0:4] = *PMD* and all remaining bytes are generated randomly and independently with uniform distribution.
