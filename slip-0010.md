...
process similar and practically compatible with [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki).
For other curves it uses a
different salt than [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki).  This avoids using the same private key
for different elliptic curves with different orders.

### Master key generation

We adapt the master key generation from [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki). 
To use different private keys for different curves we use different keys for the HMAC
...
0x00 || encodeUCoordinate(u, 255), where encodeUCoordinate is defined in 
...
as the seed byte sequence used in [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki). 
The value of S should be the binary seed obtained from a BIP-0039 mnemonic and optional passphrase or it
...
* Curve = "Bitcoin seed" for the secp256k1 curve (this is compatible
with [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)).
...
## Compatibility with [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)

Master key generation in [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) may result in an invalid key, in which case
...
specification extends the [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) definition of child key derivation so that
...
For the secp256k1 curve the SLIP-0010 derivation scheme is identical
to [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
...
receive assets and the seed is ported to a [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
wallet, then there is an infinitesimal chance that some assets
will not be discovered by the [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki)
wallet. Conversely, if a seed is used in a [BIP-0032](https://github.com/bitcoin/bips/blob/master/bip-0032.mediawiki) wallet 
to receive assets and the seed is ported to a SLIP-0010 wallet, then all assets will be discovered by
