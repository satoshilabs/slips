...
5. Set resulting key k<sub>i</sub> to parse<sub>256</sub>(I<sub>L</sub>) + k<sub>par</sub> (mod n)
6. If parse<sub>256</sub>(I<sub>L</sub>) ≥ n or k<sub>i</sub> = 0 (resulting key is invalid):
