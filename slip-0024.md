...
A valid payment request signature authenticates the request, but does not establish the correctness of information which the payer or their wallet must verify.
