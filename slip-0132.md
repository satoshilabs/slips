...
Blackcoin                                 | `0x0488b21e` - `xpub` | `0x0488ade4` - `xprv` | P2PKH or P2SH                    | m/44'/10'   |
Blackcoin                                 | `0x049d7cb2` - `ypub` | `0x049d7878` - `yprv` | P2WPKH in P2SH                   | m/49'/10'   |
Blackcoin                                 | `0x04b24746` - `zpub` | `0x04b2430c` - `zprv` | P2WPKH                           | m/84'/10'   |
Blackcoin                                 | `0x0295b43f` - `Ypub` | `0x0295b005` - `Yprv` | Multi-signature P2WSH in P2SH    | -           |
Blackcoin                                 | `0x02aa7ed3` - `Zpub` | `0x02aa7a99` - `Zprv` | Multi-signature P2WSH            | -           |
Blackcoin Testnet                         | `0x043587cf` - `tpub` | `0x04358394` - `tprv` | P2PKH or P2SH                    | m/44'/1'    |
Blackcoin Testnet                         | `0x044a5262` - `upub` | `0x044a4e28` - `uprv` | P2WPKH in P2SH                   | m/49'/1'    |
Blackcoin Testnet                         | `0x045f1cf6` - `vpub` | `0x045f18bc` - `vprv` | P2WPKH                           | m/84'/1'    |
Blackcoin Testnet                         | `0x024289ef` - `Upub` | `0x024285b5` - `Uprv` | Multi-signature P2WSH in P2SH    | -           |
Blackcoin Testnet                         | `0x02575483` - `Vpub` | `0x02575048` - `Vprv` | Multi-signature P2WSH            | -           |
